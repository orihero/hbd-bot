...
export const ru: TranslationSchema = {
  ...
  dashboard: {
    ...
    figures: {
      ...
      activeAccounts: {
        ...
        sub: "по линии на каждый: день ⊆ неделя ⊆ месяц · никогда не суммируются",
        cov: "ночной снимок",
      },
      planUtilisation: {
        title: "Насколько полно использовались планы",
        sub: "только завершённые планы · у действующего плана доля не окончательна",
        cov: "без окна",
      },
      planLiability: {
        title: "Что планы ещё должны",
        sub: "песни, не деньги · действующие и завершённые планы никогда не складываются",
        cov: "без окна",
      },
      vendorBalances: {
        title: "Балансы у провайдеров",
        sub: "по полосе на АККАУНТ · < {bad} песен критично, < {warn} мало",
      },
      pollerFreshness: {
        title: "Свежесть опроса",
        sub: "когда каждый аккаунт последний раз СПРАШИВАЛИ и когда он последний раз ОТВЕТИЛ",
      },
      songConsumption: {
        title: "Что потребляет песня",
        sub: "токены, оплаченные символы и миллисекунды аудио · без общей оси",
      },
      costProvenance: {
        title: "Как была рассчитана стоимость",
        sub: "разбиение вызовов к провайдерам, а не долларов",
        cov: "это окно",
      },
    },
    note: {
    ...
    charts: {
      ...
      cps: {
        title: "Себестоимость песни",
        sub: "расход ÷ доставлено песен · деление = 1 цент",
        cov: "только тарифицированные",
      },
      costsplit: {
  ...
  chats: {
    ...
    selectConversationHint: "Выберите диалог из списка слева для просмотра деталей.",
  ...
  users: {
    ...
    hints: {
      blocked: "«Любой» запрашивает всех: параметр отсутствует, а не равен false.",
      language:
    ...
    sort: {
      descending: "Сортировать по столбцу «{column}» — сначала наибольшие или самые недавние",
      ascending: "Сортировать по столбцу «{column}» — сначала наименьшие или самые давние",
      clear:
    ...
    broadcast: {
      ...
      ariaSegment: "Написать этим пользователям — открыть мастер рассылки с этим сегментом",
      ariaEveryone:
    ...
    empty: {
      ...
      unmatchable: "«{query}» содержит символы, которых в Telegram id быть не может. {hint}",
    },
    filter: {
      blocked: "Блокировка",
      creditBalance: "Баланс кредитов",
    ...
    credits: {
      ...
      balanceHint: "Сохранённый баланс ровно в том виде, в каком его держит журнал.",
      projectedHint:
  ...
  audit: {
    ...
    hints: {
      ...
      action:
        "Сколько угодно: повторы — это ИЛИ внутри поля и И между полями.",
    },
  ...
  admins: {
    ...
    notes: {
      ...
      stepUpTitle: "Сервер запросил повторную аутентификацию, которой у этого маршрута нет",
      stepUpMessage:
    ...
    create: {
      ...
      pending: "Создаем…",
      stepUpNote: "Создание {username} требует подтверждения для этого имени пользователя.",
  ...
  errors: {
    ...
    query: {
      ...
      stepUpTitle: "{subject}: сервер запросил повторную аутентификацию, которой у этого маршрута нет",
      ...
      rateLimitedTitle: "{subject}: API ограничивает частоту запросов этой сессии",
      rateLimitedWait: " Повторите через {seconds} с.",
      staleTitle: "{subject}: обновление остановилось",
      staleMessage: "{message} Строки ниже — последний удачный ответ, а не текущий.",
      offlineTitle: "{subject}: не удалось связаться с API",
      failedTitle: "{subject}: не удалось загрузить",
  ...
  reveal: {
    ...
    fieldHints: {
      ...
      recipientLookupKey: "Свёрнутый ключ, с которым сравнивал сопоставитель имён.",
      recipientCandidates:
      ...
      firstName: "Не имя получателя — собственное имя клиента из его контакта в Telegram.",
    ...
    actions: {
      ...
      orderForceDeliver:
        "принудительная смена статуса заказа на «доставлен»",
      ...
      orderEvidenceExport:
        "экспорт пакета подтверждений по этому заказу",
      auditExport: "экспорт журнала аудита",
      adminManage: "управление учетными записями администраторов",
      broadcastSend: "отправить эту рассылку аудитории, зафиксированной при её создании",
    },
    reasons: {
    ...
    dialog: {
      ...
      recordsUnknown: "Сервер не сообщил, сколько записей запросило это раскрытие.",
      ...
      windowResets: "Это окно сбросится через {delay}. Окно фиксированное, а не скользящее.",
      nothingCharged:
      ...
      stepUpNote: "Вы запросили снятие маски: {cost} на этом объекте ({subjectType}).",
      stepUpAsk:
      ...
      reasonTextLabel: "зачем (необязательно, {max} символов, хранится 90 дней)",
      ceilingsSeparate: " Два лимита независимы: расход одного не тратит другой.",
      ...
      returnedRecords: "Возвращено {returned} из {charged} оплаченных записей. ",
      chargeIsThePage:
    ...
    dateRange: {
      ...
      halfOpenHint: "Полуоткрытый интервал: «с» включается, «по» — нет. Время в {zone}.",
      bothEndsHint:
  ...
  broadcasts: {
    ...
    newCampaignAria: "Новая рассылка — составить сообщение и зафиксировать аудиторию",
    ...
    filter: {
      state: "Состояние",
      stateHint: "Несколько сразу — это ИЛИ: параметр повторяется, и API читает его именно так.",
      kind: "Вид",
      kindHint: "Вид объявляется при составлении рассылки, и правка текста его не меняет.",
    },
    chips: {
      state: "Состояние",
      kind: "Вид",
    ...
    stateHint: {
      ...
      sending: "Сообщения уходят прямо сейчас. Счётчики растут сами, без действий на этом экране.",
      paused:
    ...
    audience: {
      ...
      incomplete: "Аудитория ещё записывается, поэтому эти числа не окончательные.",
      everyone:
    ...
    detail: {
      ...
      countersHint: {
        audience: "Сколько насчитал сегмент при составлении. Больше не меняется.",
        written: "Сколько строк получателей развёртывание записало на данный момент.",
        unsettled: "Строки без итога — ждут очереди или взяты обработчиком прямо сейчас.",
        ...
        settled: "Сумма пяти конечных исходов. Эти пять не обязаны совпасть с размером аудитории.",
      },
      facts: {
        createdBy: "Составил",
      ...
      body: {
        ...
        imageCached: "уже загружено один раз — следующая отправка загрузки не стоит",
        imageNotCached: "ещё не загружено — за загрузку заплатит первый получатель",
      ...
      recipients: {
        ...
        emptyMessage: "Аудитория ещё записывается, либо эта рассылка не выбрала никого.",
        emptyFilteredTitle: "Под этот фильтр не подходит ни один получатель",
        emptyFilteredMessage: "Строки могут быть у другого итога — снимите фильтр, чтобы их увидеть.",
        noIdColumnNote:
    ...
    actions: {
      send: "Отправить",
      sendAria: "Отправить — авторизовать рассылку по зафиксированной аудитории",
      pause: "Приостановить",
      resume: "Продолжить",
    ...
    sendDialog: {
      ...
      atLabel: "Отправить в",
      atHint: "В вашем часовом поясе. Рассылку подхватывает планировщик, а не этот экран.",
      atInPast: "Этот момент уже прошёл. Выберите более поздний или отправьте сейчас.",
    ...
    wizard: {
      ...
      audience: {
        ...
        refusalCounting: "Считаем аудиторию… следующий шаг откроется, когда придёт число.",
        refusalInvalid:
      ...
      message: {
        ...
        counter: "{sent} из {limit} символов так, как их считает Telegram (набрано {typed}).",
        markupHint:
        ...
        buttonHint: "Кнопке нужны и подпись, и ссылка — либо ни того, ни другого.",
        ...
        previewUnparsed: "Предпросмотр невозможен, пока разметка ниже не исправлена.",
        ...
        issues: {
          ...
          selfClosing: "Самозакрывающийся тег — это не разметка Telegram; напишите пару.",
          unbalanced: "Тег не закрыт или закрывает тот, который не открывали.",
          nestedLink: "Ссылка не может содержать другую ссылку.",
          notMarkup: "В тексте есть комментарий или объявление — это не разметка.",
          ...
          badUrl: "Ссылка кнопки должна быть абсолютным http(s)-URL с публичным хостом.",
          buttonPair: "Кнопке нужны и подпись, и ссылка — либо ни того, ни другого.",
          badStorageKey: "Это не ключ хранилища, который записало это развёртывание.",
        },
        testSend: {
          ...
          recipientHint: "Только цифры. Аккаунт должен быть в списке тестовых получателей.",
      ...
      review: {
        ...
        submitLater: "Зафиксировать аудиторию и запланировать для {count} людей",
        pending: "Отправляем…",
        stepUpNote:
  ...
  segments: {
    ...
    summary: "Правил: {rules} из {maxRules} · вложенность {depth} из {maxDepth}",
    ...
    unavailableField: "Требуется таблица {capability}, которой нет в этой установке.",
    unavailableOption: "{label} — здесь недоступно",
    aggregateField: "Считается по другим таблицам, поэтому такое правило дороже выполняется.",
    ...
    ruleLimitReached: "В сегменте уже {maxRules} правил — это серверный предел.",
    matchLabel: "Как они сочетаются",
    loading: "Читаем реестр полей…",
    loadFailed: "Реестр полей не удалось прочитать, поэтому правило составить нельзя.",
    forbidden: "У вашей роли нет доступа к рассылкам, поэтому реестр полей закрыт.",
    match: {
      all: "Все",
      any: "Любое",
      none: "Ни одно",
    ...
    opHints: {
      ...
      within_next_days: "Отсчёт идёт вперёд от текущего момента и никогда не смотрит в прошлое.",
    ...
    value: {
      ...
      wholeMonthHint: "Заполняет обе границы этим месяцем в вашем часовом поясе.",
      days: "Дней",
      daysPreset: "{days} дн.",
    ...
    sort: {
      ...
      nullsSortLow: "Аккаунты без этого события сортируются как ноль или как начало эпохи.",
    },
    issues: {
      ...
      maxValueMembers: "В поле «{field}» {actual} значений, а сервер принимает не более {limit}.",
      maxAggregateRules:
      ...
      unavailableField: "Для поля «{field}» нужна таблица, которой нет в этой установке.",
      ...
      daysOutOfRange: "Для поля «{field}» число дней должно быть от {min} до {max}.",
  ...
  billing: {
    ...
    lookup: {
      ...
      submit: "Найти",
      malformed: "Это не ссылка. И ссылка на платёж, и идентификатор транзакции Payme — ровно 24 шестнадцатеричных символа.",
    ...
    lifeline: {
      ...
      notes: {
        neverOpened: "Payme ни разу не открывала транзакцию по этому платежу. Так же выглядит платёж, закрытый вручную.",
        awaitingRail: "Транзакция открыта, и канал пока не ответил. Наши часы и часы Payme — разные часы, поэтому это ожидание, а не опоздание.",
        buyerErased: "Покупатель попросил себя забыть. Деньги прошли, а выдавать кредит и сообщать уже некому — это состояние, а не расхождение.",
        planGrantsNothing: "Тариф выдаёт песни по мере использования, поэтому при покупке кредит не начисляется.",
        notSettled: "Этот платёж не завершился, поэтому всё последующее и не должно было произойти.",
        alreadyTold: "Подтверждение отправлено.",
        purged: "Строка, где это было записано, удалена по сроку хранения. Событие было; свидетельство устарело и удалено.",
      },
    },
    dossier: {
      ...
      notFoundMessage: "На этой установке нет платежа с таким идентификатором. Проверьте ссылку в поле поиска на доске.",
      intentPanel: "Платёж",
      ...
      transactionsNone: "Payme ни разу не открывала транзакцию по этому платежу.",
      ...
      callsPurged: "Этот платёж старше 90 дней, которые хранится журнал входящих, поэтому его вызовы удалены по сроку. Удалены, а не отсутствовали.",
      chainStopSingle: "Ответа нет по устройству системы. Баланс кредитов — одно число без партий, поэтому ни один запрос не докажет, какую песню оплатил купленный кредит.",
      chainStopPlan: "Использовано {used} из {included} песен по тарифу.",
      chainStopPlanUnknown: "Запись о покупке тарифа не найдена, поэтому песни по нему никто не считает.",
      settleByHand: "Закрыть вручную",
      settleByHandCaveat: "Консоль этого не делает и не предложит. Команда выполняется в терминале и только после того, как списание по этой ссылке подтверждено в кабинете Payme, который этот процесс не имеет права видеть.",
    ...
    notify: {
      ...
      confirmBody: "Клиент получит сообщение о платеже, который уже совершил. Ничего не списывается, кредит не выдаётся, денежные строки не пишутся. Двойное нажатие отправит одно сообщение.",
      confirmLabel: "Отправить подтверждение",
      refusalNotPaid: "Этот платёж не завершён, подтверждать нечего.",
      refusalBuyerErased: "Покупатель попросил себя забыть. Отправлять некому; продажа и кредит не тронуты.",
      refusalAlreadyNotified: "Подтверждение уже отправлено. Задача останавливается на этой отметке, поэтому повтор ничего не даст.",
      sent: "Поставлено в очередь. Воркер отправит в течение минуты.",
      replayed: "Уже в очереди — это нажатие ничего не изменило, и так и должно быть.",
      reasonLabel: "Почему отправляем повторно",
      reasonHint: "Попадёт в журнал аудита на ваше имя. Ваши слова, а не слова клиента.",
      notDelivered: "Здесь записано, что мы отправили. Увидел ли клиент — факт на стороне Telegram, которого в этой базе нет.",
    },
    pause: {
      pauseAction: "Приостановить оплату",
      resumeAction: "Возобновить оплату",
      pauseTitle: "Приостановить выдачу оплат?",
      pauseBody: "Бот перестанет выдавать новые ссылки на оплату. На платежи в процессе это не влияет, деньги никуда не двигаются. Любой оператор вернёт это одним нажатием.",
      pauseLabel: "Приостановить оплату",
      pausePending: "Приостанавливаем…",
      resumeTitle: "Возобновить выдачу оплат?",
      resumeBody: "Бот снова начнёт выдавать ссылки на оплату. Ничего из того, что случилось на паузе, не повторяется.",
    ...
    calls: {
      ...
      emptyMessage: "На работающем канале так же выглядит платёж, закрытый вручную, поэтому это никогда не значит «шлюз лежит».",
      emptyFiltered: "Ни один вызов не подходит под фильтры",
      emptyFilteredMessage: "Вызовы на этой установке есть, но ни один не попадает в выбранный интервал или вид.",
      emptyFailed: "Журнал не загрузился",
      emptyFailedMessage: "В примечании выше — ответ сервера и идентификатор корреляции, который стоит указать.",
      chips: {
        method: "Метод",
        faultsOnly: "Только ошибки",
        reference: "Ссылка",
