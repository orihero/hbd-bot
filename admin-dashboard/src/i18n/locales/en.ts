...
export const en: TranslationSchema = {
  ...
  auth: {
    ...
    loginSubtitle: "Operator credentials for the HBD Bot console.",
    ...
    consoleTitle: "HBD Bot Operations Console",
    consoleDescription:
      "Customer care, song generation pipeline, audit log, and system configuration for the Happy Birthday Bot.",
    ...
    login: {
      ...
      subtitle: "Operator credentials for the HBD Bot console.",
      username: "Username",
      password: "Password",
    ...
    console: {
      heroTitle: "The operator console for the hbd birthday-song bot",
      heroDescription:
  ...
  admins: {
    ...
    noWritesNote:
      "This build has no admin-account writes. The CLI (hbd.admin.bootstrap) only creates the first Owner, or recovers one when no active Owner is left, and you change your own password from this console. Creating another operator, changing a role, resetting somebody else's password and deactivating an account have no supported path here or on the CLI yet; a button for them would only 404.",
  ...
  errors: {
    ...
    detail: {
      ...
      misconfiguredMessage:
        "The API refused the request's origin. That is a deployment fault, not something you did and not something a retry fixes — HBD_ADMIN_PUBLIC_ORIGIN does not match where this panel is served from.",
    ...
    query: {
      ...
      originMessage:
        "{message} That is a deployment setting (HBD_ADMIN_PUBLIC_ORIGIN), not something you did — retrying cannot change it.",
