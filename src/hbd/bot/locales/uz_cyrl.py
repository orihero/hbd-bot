...
CATALOGUE: Final[dict[str, str]] = {
    ...
    # -- start -------------------------------------------------------------
    "start.welcome": (
        "🎂 Салом! Мен шахсий табрик тўпламини тайёрлайман: битта қўшиқ, учта овозли "
        "табрик ва қўшиқ матни — исм тўғри талаффуз қилинган ҳолда."
    ),
    ...
    "wizard.output_language.prompt": "Қўшиқ ва табриклар қайси тилда бўлсин?",
