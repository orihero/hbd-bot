...
class NavAction(StrEnum):
    ...
    #: :class:`~hbd.bot.pricing.CheckoutOffer` sets out: the checkout is the Confirm screen
    ...
    #: catalogues would silently disagree with ``HBD_SINGLE_SONG_PRICE_MINOR`` the day an
