...
* Turn every httpx failure mode into a typed :class:`~hbd.errors.HbdError`. Nothing in
...
from hbd.contracts import Err, HealthState, ProviderHealth, Result, err, ok
...
def http_status_of(error: HbdError) -> int | None:
