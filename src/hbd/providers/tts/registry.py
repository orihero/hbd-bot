...
from hbd.contracts import Language, Result, VoiceDescriptor, VoiceGender, err, ok
...
# second vendor means supplying its ids through ``HBD_TTS_VOICE_REGISTRY_JSON`` at the same
