...
(:class:`hbd.contracts.Vendor`) comes from the base URL's host. That is not a guess about
...
the host is the only fact in the configuration that knows. ``HBD_LLM_PROVIDER=openai``
...
from hbd.contracts import LlmProvider, Vendor
