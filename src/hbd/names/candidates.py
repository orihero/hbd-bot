...
by reordering ``HBD_NAME_CANDIDATE_ORDER``; this module reads whatever order it is handed
...
from hbd.contracts import MAX_CANDIDATE_CHARS, Language, NameCandidate, NameStrategy, Script
from hbd.logging import get_logger
from hbd.names.forms import DisplayForm, SubmitForm
from hbd.names.marks import strip_marks, to_ascii_marks
from hbd.names.phonetic import respell_phonetically
from hbd.names.script import detect_script
from hbd.names.syllables import hyphenate
from hbd.names.translit import transliterate
