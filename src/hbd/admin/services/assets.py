...
key is rebuilt server-side through :func:`hbd.storage.archive_key` from the row's
...
from hbd.admin.audit_sink import UNSTORABLE_USERNAME
from hbd.admin.container import AdminContainer
from hbd.admin.deps import CurrentAdmin, enforce_reveal_budget, enforce_step_up
...
from hbd.contracts import LyricDraft
...
from hbd.db.mapping import lyrics_from_payload
...
_WINDOW_KEY_PREFIX: Final[str] = "hbd:admin:reveal:window"
...
class AssetMedia:
    ...
    Deliberately not :class:`hbd.db.admin.views.AssetView`: that projection drops ``path``
