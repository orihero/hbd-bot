...
``hbd.logging`` masks by *key name*, and ``password`` would be masked, but only once the value
...
from hbd.admin.schemas.common import MAX_PASSWORD_CHARS, MIN_PASSWORD_CHARS, ApiModel
