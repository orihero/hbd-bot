...
subject or a new column is a member of :class:`~hbd.admin.schemas.reveal.RevealField`, not a
...
:func:`~hbd.admin.deps.enforce_step_up`. Both run on every request; neither is decorative
...
4. **Audit, then read** — :func:`~hbd.admin.services.reveal.perform_reveal`, which commits
