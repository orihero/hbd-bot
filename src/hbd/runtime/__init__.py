...
vendor, so ``HBD_USE_FAKE_PROVIDERS=1`` can swap all six of them at once and the rest of
...
from hbd.runtime.jobs import build_kit_worker_settings, generate_and_deliver
