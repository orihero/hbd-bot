...
It is its own module rather than another function in :mod:`hbd.runtime.jobs` for
:mod:`hbd.runtime.retention_job`'s stated reason: it shares nothing with the kit job — no
...
from hbd.db.activity import ActivityCounts, measure_activity, record_snapshot
