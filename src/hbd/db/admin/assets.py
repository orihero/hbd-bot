...
through ``POST /reveal`` alone. ``asset_view`` (shared with ``hbd.db.admin.orders``, so
...
from hbd.db.admin.orders import asset_view
...
from hbd.db.admin.sql import TimeWindow, apply_in, apply_window
from hbd.db.admin.views import AssetView
