...
``bot_membership_events``' footing — a cutoff applied at sweep time in ``hbd.db.purge``, and
...
from hbd.db.base import Base, UtcDateTime
from hbd.db.models.payme_transaction import PAYME_TRANSACTION_ID_LENGTH
from hbd.db.models.payment_intent import PUBLIC_REF_LENGTH
