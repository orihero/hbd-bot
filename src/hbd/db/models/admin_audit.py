...
Append-only. There is exactly one writer, :func:`hbd.db.admin.audit.append`, and exactly two
...
class AuditOutcome(StrEnum):
    ...
    Declared here rather than in ``hbd.db.enums`` because nothing outside this table has an
...
class AdminAuditRow(Base):
    ...
    under a lock by :func:`hbd.db.admin.audit.append`, which is the only supported write path
