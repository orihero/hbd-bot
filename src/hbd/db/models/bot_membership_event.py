...
``hbd.db.purge.BOT_MEMBERSHIP_RETENTION_DAYS`` — a 400-day CUTOFF on ``at``, thirteen months
...
from hbd.contracts import BotBlockSource, BotMembershipEvent
from hbd.db.base import Base, UtcDateTime, enum_type
