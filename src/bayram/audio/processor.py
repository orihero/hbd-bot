...
* every ffmpeg run goes through :func:`bayram.audio.runner.run_command`, so a non-zero exit,
...
from bayram.contracts import AudioProbe, Err, Result, err, ok
...
class FfmpegAudioPostProcessor:
    """Satisfies ``bayram.contracts.AudioPostProcessor`` structurally. Immutable.
