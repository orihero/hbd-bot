...
def brand_command(
    ...
    *,
    ...
    :func:`bayram.audio.cover.render_cover` as a JPEG already, so a re-encode would cost
    ...
    :data:`~bayram.audio.constants.BRAND_HYGIENE_ARGS` is spliced in above the tag pairs and
