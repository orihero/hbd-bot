"""Audio post-processing: ffmpeg behind ``bayram.contracts.AudioPostProcessor``.

Four things ship from here.

**The post-processor.** :class:`~bayram.audio.processor.FfmpegAudioPostProcessor` does the
...
**The startup check.** :func:`~bayram.audio.startup.ensure_ffmpeg_available` must be called
...
from bayram.audio.cover import COVER_MIME, COVER_SIZE, COVER_SUFFIX, render_cover
from bayram.audio.loudnorm import LoudnormMeasurement, parse_loudnorm_report
