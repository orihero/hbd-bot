...
from bayram.contracts import Err, Result, StoredObject, err, ok
from bayram.errors import NotFoundError, StorageError, ValidationError
...
class LocalFileStorage:
    """Filesystem-backed ``bayram.contracts.Storage``. Safe to share across tasks."""
