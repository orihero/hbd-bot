...
#: ``bayram.db.purge`` nor a per-user erasure. One ``BAYRAM_LOG_LEVEL=DEBUG`` would otherwise turn
...
_CORRELATION_ID: ContextVar[str] = ContextVar("bayram_correlation_id", default="-")
...
class JsonFormatter(logging.Formatter):
    ...
    def format(self, record: logging.LogRecord) -> str:
        ...
        if record.exc_info is not None:
            ...
            if isinstance(error, BayramError):
