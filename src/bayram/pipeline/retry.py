...
The decision to retry is never guessed here: it is read off ``BayramError.is_retryable``,
...
from bayram.contracts import Err, Result, err
from bayram.errors import BayramError, PipelineError
from bayram.logging import get_logger
from bayram.pipeline.ports import Sleeper
...
async def call_with_retry[T](
    ...
    *,
    ...
    policy: RetryPolicy,
    sleeper: Sleeper,
    on_retry: Callable[[int, BayramError], Awaitable[None]] | None = None,
