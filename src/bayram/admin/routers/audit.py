...
(:func:`bayram.db.admin.audit.write_head_anchor`), on a schedule, in a transaction of its own.
...
from bayram.admin.schemas.audit import (
    AuditPage,
    AuditPageMeta,
    ChainVerifyResponse,
    CursorError,
...
from bayram.admin.security.permissions import Permission, grant_for
...
def build_query(
    ...
    The naive-instant refusal is :func:`bayram.admin.window.require_aware` and not a copy of it.
