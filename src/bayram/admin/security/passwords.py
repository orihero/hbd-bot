...
run it at one-round cost while production runs the ``BAYRAM_ADMIN_ARGON2_*`` values. The
...
#: OWASP's argon2id baseline, and the defaults of the ``BAYRAM_ADMIN_ARGON2_*`` settings.
...
_DUMMY_PASSWORD: Final[str] = "bayram-admin-nonexistent-account-placeholder"
