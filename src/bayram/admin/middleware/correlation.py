...
the exact shape ``bayram.logging.new_correlation_id`` produces — and silently replaced
...
The id is bound through ``bayram.logging.correlation_scope``, so every log line the request
