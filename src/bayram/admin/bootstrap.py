"""``python -m bayram.admin.bootstrap`` — the first OWNER, and the way back from losing one.
...
* folding the guard into the write (:func:`bayram.db.admin.accounts.insert_first_owner`,
...
from bayram.admin.container import AdminContainer, admin_container
from bayram.admin.schemas.common import MAX_PASSWORD_CHARS, MIN_PASSWORD_CHARS
from bayram.admin.security.passwords import hash_password
from bayram.admin.sessions import revoke_sessions_for_user
...
def _parse(argv: Sequence[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        prog="python -m bayram.admin.bootstrap",
