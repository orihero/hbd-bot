...
#: Configured as ``BAYRAM_ADMIN_PUBLIC_ORIGIN=*``: accept every ``Origin``, and accept a
...
CSRF_COOKIE_NAME: Final[str] = "__Host-bayram_csrf"
SESSION_COOKIE_NAME: Final[str] = "__Host-bayram_session"
