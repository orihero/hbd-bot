...
:class:`~bayram.admin.schemas.reveal.RevealRequest` inherits it too — it did not, for one
...
The three constants are **declared here** and imported by :mod:`bayram.admin.schemas.reveal`,
...
from bayram.db.models.admin_audit import REASON_REF_LENGTH, REASON_TEXT_LENGTH
...
class ReasonedRequest(ApiModel):
    ...
    :class:`~bayram.admin.schemas.reveal.RevealRequest` inherits this rather than restating it,
