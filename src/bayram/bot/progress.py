...
from bayram.pipeline.events import PipelineStage, ProgressEvent, ProgressStatus
...
class TelegramProgressSink:
    """Edits one Telegram message per order. Satisfies ``bayram.pipeline.events.ProgressSink``.
