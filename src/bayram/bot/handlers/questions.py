...
from bayram.bot.draft import MAX_NOTE_CHARS, LyricSource, WizardDraft
...
from bayram.bot.handlers.lyrics import enter_lyrics_step, retagged
from bayram.bot.i18n import translate
from bayram.bot.states import Wizard, WizardStep, next_step
...
async def handle_own_lyrics(callback: CallbackQuery, state: FSMContext) -> None:
    ...
    It also switches the wizard onto :data:`~bayram.bot.states.OWN_LYRICS_ORDER`, and the very
