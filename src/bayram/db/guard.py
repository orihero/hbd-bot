...
* an ``BayramError`` raised by the mapping layer is already typed and passes through intact.
...
from bayram.errors import BayramError, NotFoundError, StorageError, ValidationError
...
async def run_guarded[T](
    ...
    **context: Any,
    ...
    try:
        ...
        error: BayramError = StorageError(
