...
from hbd.audio.constants import ID3V2_VERSION, INTERMEDIATE_CODEC
...
TAGS: tuple[tuple[str, str], ...] = (
    ("title", "Tugʻilgan kun"),
    ("artist", "@hbduzbot"),
    ("album", "Generate yours at @hbduzbot"),
    ("comment", "This song has been generated by @hbduzbot"),
)
...
def test_brand_command_passes_a_tag_value_with_spaces_as_one_argv_element() -> None:
    ...
    # Assert
    assert "comment=This song has been generated by @hbduzbot" in argv
