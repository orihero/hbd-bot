...
and :func:`bayram.watermark.contains_watermark` is the predicate they assert with.
"""
...
import bayram.watermark as watermark
...
def test_the_watermark_is_recognised_whatever_case_it_arrives_in() -> None:
    ...
    # Act / Assert
    assert contains_watermark("THIS SONG HAS BEEN GENERATED BY @BAYRAM_UZBOT")
